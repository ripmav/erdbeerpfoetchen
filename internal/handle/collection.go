...
func (h *CollectionHandler) write(w http.ResponseWriter, r *http.Request) {
	...
	slog.Debug("collection collection successful written")
...
func (h *CollectionHandler) read(w http.ResponseWriter, r *http.Request) {
	...
	c, err := h.service.ReadCollection(ctx, collectionKey, userKey, userId)
	if err != nil {
	...
	slog.Debug("collection collection successful read")
